...
const Homepage = () => {
	...
	const requestApi = async () => {
		await axios({
			method: 'get',
			url: 'https://todo.api.devcode.gethired.id/activity-groups?email=riodwisyahputra25@gmail.com',
		})
			.then((response) => {
	...
	const createActivity = async () => {
		await axios({
			...
			data: {
				title: 'New Activity',
				email: 'riodwisyahputra25@gmail.com',
			},
		})
			.then(() => {})
			.catch((error) => {
	...
	const deleteActivity = async () => {
		await axios({
			method: 'delete',
			url: `https://todo.api.devcode.gethired.id/activity-groups/${selectedId}?email=riodwisyahputra25@gmail.com`,
		})
			.then(() => {})
			.catch((error) => {
				console.log(error);
